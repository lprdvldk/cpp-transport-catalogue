...
KeyItemContext BuilderContextBase::Key(std::string key) {
    return builder_.Key(std::move(key));
}

Builder& BuilderContextBase::Value(Node::Value value) {
    return builder_.Value(std::move(value));
}

DictItemContext BuilderContextBase::StartDict() {
    return builder_.StartDict();
}

Builder& BuilderContextBase::EndDict() {
    return builder_.EndDict();
}

ArrayItemContext BuilderContextBase::StartArray() {
    return builder_.StartArray();
}

Builder& BuilderContextBase::EndArray() {
    return builder_.EndArray();
}

Node BuilderContextBase::Build() {
