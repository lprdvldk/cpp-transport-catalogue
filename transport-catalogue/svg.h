...
struct Rgb {
    ...
    Rgb(int r, int g, int b)
        : red(static_cast<uint8_t>(r)), green(static_cast<uint8_t>(g)), blue(static_cast<uint8_t>(b)) {
    }
    uint8_t red = 0;
    uint8_t green = 0;
    uint8_t blue = 0;
...
struct Rgba {
    ...
    Rgba(int r, int g, int b, double a)
        : red(static_cast<uint8_t>(r)), green(static_cast<uint8_t>(g)), blue(static_cast<uint8_t>(b)), opacity(a) {
    }
    uint8_t red = 0;
    uint8_t green = 0;
    uint8_t blue = 0;
